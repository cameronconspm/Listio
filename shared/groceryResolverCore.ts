...
export const COMMON_GROCERY_CATALOG: CommonGroceryCatalogEntry[] = [
  ...
  { normalized_name: 'yogurt', category: 'Dairy', zone_key: 'dairy_eggs', aliases: ['yogurt', 'greek yogurt', 'plain yogurt', 'nonfat plain yogurt', 'nonfat yogurt'] },
  ...
  { normalized_name: 'cauliflower', category: 'Vegetables', zone_key: 'produce', aliases: ['cauliflower'] },
  { normalized_name: 'olives', category: 'Pantry', zone_key: 'pantry', aliases: ['olives', 'olive', 'black olives', 'green olives', 'kalamata olives'] },
  { normalized_name: 'raspberries', category: 'Fruit', zone_key: 'produce', aliases: ['raspberries', 'raspberry'] },
  { normalized_name: 'blackberries', category: 'Fruit', zone_key: 'produce', aliases: ['blackberries', 'blackberry'] },
  { normalized_name: 'pasta sauce', category: 'Pantry', zone_key: 'pantry', aliases: ['pasta sauce', 'marinara sauce', 'tomato sauce', 'spaghetti sauce'] },
  { normalized_name: 'jam', category: 'Pantry', zone_key: 'pantry', aliases: ['jam', 'jelly', 'preserves', 'strawberry jam'] },
  { normalized_name: 'honey', category: 'Pantry', zone_key: 'pantry', aliases: ['honey'] },
  { normalized_name: 'maple syrup', category: 'Pantry', zone_key: 'pantry', aliases: ['maple syrup'] },
  { normalized_name: 'oats', category: 'Pantry', zone_key: 'pantry', aliases: ['oats', 'oatmeal', 'rolled oats'] },
  { normalized_name: 'quinoa', category: 'Pantry', zone_key: 'pantry', aliases: ['quinoa'] },
  { normalized_name: 'tuna canned', category: 'Canned', zone_key: 'pantry', aliases: ['canned tuna', 'tuna can'] },
  { normalized_name: 'soup', category: 'Canned', zone_key: 'pantry', aliases: ['soup', 'canned soup', 'chicken noodle soup'] },
  { normalized_name: 'soda', category: 'Drinks', zone_key: 'snacks_drinks', aliases: ['soda', 'cola', 'soft drink', 'diet soda'] },
  { normalized_name: 'sports drink', category: 'Drinks', zone_key: 'snacks_drinks', aliases: ['sports drink', 'gatorade'] },
  { normalized_name: 'popcorn', category: 'Snacks', zone_key: 'snacks_drinks', aliases: ['popcorn'] },
  { normalized_name: 'soap', category: 'Personal Care', zone_key: 'personal_care', aliases: ['soap', 'body wash'] },
  { normalized_name: 'hummus', category: 'Deli', zone_key: 'bakery_deli', aliases: ['hummus'] },
  { normalized_name: 'deli turkey', category: 'Deli', zone_key: 'bakery_deli', aliases: ['deli turkey', 'turkey slices', 'sliced turkey'] },
  { normalized_name: 'frozen berries', category: 'Frozen', zone_key: 'frozen', aliases: ['frozen berries', 'frozen fruit'] },
  { normalized_name: 'frozen fries', category: 'Frozen', zone_key: 'frozen', aliases: ['frozen fries', 'french fries', 'tater tots'] },
  { normalized_name: 'granola bars', category: 'Snacks', zone_key: 'snacks_drinks', aliases: ['granola bars', 'granola bar', 'protein bar'] },
  { normalized_name: 'pretzels', category: 'Snacks', zone_key: 'snacks_drinks', aliases: ['pretzels', 'pretzel'] },
  { normalized_name: 'cookies', category: 'Snacks', zone_key: 'snacks_drinks', aliases: ['cookies', 'cookie'] },
  { normalized_name: 'almond milk', category: 'Dairy', zone_key: 'dairy_eggs', aliases: ['almond milk', 'oat milk', 'soy milk'] },
  { normalized_name: 'creamer', category: 'Dairy', zone_key: 'dairy_eggs', aliases: ['coffee creamer', 'creamer'] },
  { normalized_name: 'tofu', category: 'Produce', zone_key: 'produce', aliases: ['tofu', 'firm tofu', 'silken tofu'] },
  { normalized_name: 'tortilla chips', category: 'Snacks', zone_key: 'snacks_drinks', aliases: ['tortilla chips', 'nacho chips'] },
  { normalized_name: 'pickles', category: 'Pantry', zone_key: 'pantry', aliases: ['pickles', 'pickle', 'dill pickles'] },
  { normalized_name: 'raisins', category: 'Pantry', zone_key: 'pantry', aliases: ['raisins', 'raisin'] },
  { normalized_name: 'nuts', category: 'Pantry', zone_key: 'pantry', aliases: ['nuts', 'mixed nuts', 'almonds', 'walnuts', 'cashews'] },
  { normalized_name: 'lentils', category: 'Pantry', zone_key: 'pantry', aliases: ['lentils', 'dried lentils'] },
  { normalized_name: 'coconut oil', category: 'Pantry', zone_key: 'pantry', aliases: ['coconut oil'] },
  { normalized_name: 'sesame oil', category: 'Pantry', zone_key: 'pantry', aliases: ['sesame oil'] },
  { normalized_name: 'rice vinegar', category: 'Pantry', zone_key: 'pantry', aliases: ['rice vinegar'] },
  { normalized_name: 'bbq sauce', category: 'Condiments', zone_key: 'pantry', aliases: ['bbq sauce', 'barbecue sauce'] },
  { normalized_name: 'ranch dressing', category: 'Condiments', zone_key: 'pantry', aliases: ['ranch dressing', 'ranch'] },
  { normalized_name: 'salad dressing', category: 'Condiments', zone_key: 'pantry', aliases: ['salad dressing', 'dressing'] },
  { normalized_name: 'taco shells', category: 'Pantry', zone_key: 'pantry', aliases: ['taco shells', 'taco kit'] },
  { normalized_name: 'breadcrumbs', category: 'Pantry', zone_key: 'pantry', aliases: ['breadcrumbs', 'bread crumbs', 'panko'] },
  { normalized_name: 'chicken nuggets', category: 'Frozen', zone_key: 'frozen', aliases: ['chicken nuggets', 'frozen chicken nuggets'] },
  { normalized_name: 'waffles', category: 'Frozen', zone_key: 'frozen', aliases: ['waffles', 'frozen waffles'] },
  { normalized_name: 'bleach', category: 'Cleaning', zone_key: 'household_cleaning', aliases: ['bleach'] },
  { normalized_name: 'trash bags', category: 'Household', zone_key: 'household_cleaning', aliases: ['trash bags', 'garbage bags'] },
  { normalized_name: 'aluminum foil', category: 'Household', zone_key: 'household_cleaning', aliases: ['aluminum foil', 'tin foil', 'foil'] },
  { normalized_name: 'plastic wrap', category: 'Household', zone_key: 'household_cleaning', aliases: ['plastic wrap', 'cling wrap', 'saran wrap'] },
  { normalized_name: 'deodorant', category: 'Personal Care', zone_key: 'personal_care', aliases: ['deodorant'] },
  { normalized_name: 'conditioner', category: 'Personal Care', zone_key: 'personal_care', aliases: ['conditioner'] },
];
